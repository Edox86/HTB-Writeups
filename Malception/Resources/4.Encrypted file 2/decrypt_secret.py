...
# ----------------------------------------------------------------------
ENC_PATH   = Path("Official.pdf.enc")     # ciphertext from the malware
OUT_PATH   = Path("Official.pdf")         # decrypted output
MD5_B64    = "6hm8yZvn7VkMIP9G0EUb/A==" # [+] MD5 (Base64) you recovered
